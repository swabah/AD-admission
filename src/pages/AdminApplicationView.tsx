...
import { getApplicationById, updateApplicationStatus } from "../services/supabase";
...
const STATUS_OPTIONS = [
  ...
  { value: "reviewing", label: "Under Review", color: "#7c3aed", bg: "#ede9fe" },
...
const AdminApplicationView = () => {
    ...
    return (
      <div style={{ 
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ marginTop: 16, color: "var(--text-secondary)" }}>Loading application...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div style={{ 
        ...
        <div style={{ 
          ...
          <h2 style={{ marginBottom: 16, color: "var(--text)" }}>Application Not Found</h2>
  ...
  const currentStatus = STATUS_OPTIONS.find(s => s.value === application.status) || STATUS_OPTIONS[0];
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: "12px", alignItems: "center", flexWrap: "wrap" }}>
          ...
          <span style={{
            ...
            padding: "4px 12px",
            borderRadius: 20,
            background: application.admissionType === "local" ? "#fef3c7" : "#dbeafe",
            color: application.admissionType === "local" ? "#d97706" : "#2563eb",
            fontWeight: 500
          }}>
            {application.admissionType === "local" ? "Local / Re-admission" : "New Admission"}
          </span>
        </div>
      ...
      <main style={{ padding: "40px 20px", maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <div className="form-grid col-2">
            ...
            <InfoItem label="Aadhar Number" value={application.aadhar} fullWidth />
            <InfoItem label="Residential Address" value={application.address} fullWidth />
          </div>
        </div>
        ...
        <div style={{
          ...
          <div className="form-grid col-2">
            <InfoItem label="Applying for Class" value={application.applyClass} />
            ...
            <InfoItem label="Percentage / Grade" value={application.prevPercentage} />
            <InfoItem label="Achievements" value={application.achievements} fullWidth />
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ width: 2, height: 12, background: "var(--gold)", borderRadius: 2 }} />
            Father's Details
          </div>
          <div className="form-grid col-2" style={{ marginBottom: "20px" }}>
            <InfoItem label="Father's Name" value={application.fatherName} />
            <InfoItem label="Father's Occupation" value={application.fatherOcc} />
          ...
          <div className="form-grid col-2" style={{ marginBottom: "20px" }}>
            ...
            <InfoItem label="Mother's Occupation" value={application.motherOcc} />
          ...
          <div className="form-grid col-2">
            ...
            <InfoItem label="How did you hear about us?" value={application.referral} />
            <InfoItem label="Emergency Contact Name" value={application.emergencyName} />
            <InfoItem label="Emergency Contact Phone" value={application.emergencyPhone} />
            <InfoItem label="Medical Conditions" value={application.medical} fullWidth />
            <InfoItem label="Additional Remarks" value={application.remarks} fullWidth />
          </div>
        </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: "14px", color: "var(--text-secondary)", marginBottom: "8px" }}>
            Application submitted on {new Date(application.submissionDate).toLocaleString()}
          </p>
...
const InfoItem = ({ label, value, fullWidth = false }: { label: string; value?: string; fullWidth?: boolean }) => (
  <div className={`form-group ${fullWidth ? "full" : ""}`} style={{ marginBottom: "16px" }}>
    <label style={{ 
      display: "block", 
      fontSize: "11px", 
      fontWeight: 600,
