				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
					<Link to="/" className="flex items-center gap-4 group">
						...
						<div className="hidden sm:block">
							<span className="text-white font-display font-bold text-lg block leading-none mb-1">Ahlussuffa Dars</span>
							<span className="text-[#c8922a] text-[10px] uppercase font-bold tracking-widest block leading-none">Admission Portal</span>
						</div>
					</Link>

					<nav className="flex items-center gap-3 sm:gap-6">
						<Link to="/locate" className="text-white/60 hover:text-white text-xs font-bold uppercase tracking-widest transition-colors flex items-center gap-2">
							<Search className="w-4 h-4" />
							<span className="hidden md:inline">Locate Application</span>
						</Link>
						<Button asChild size="sm" className="bg-[#c8922a] hover:bg-[#b07d20] text-[#0a1628] font-bold rounded-lg px-4 h-10 shadow-lg">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
					<div className="flex flex-col items-center text-center max-w-4xl mx-auto">
						...
						<h1 className="text-4xl sm:text-5xl md:text-7xl font-display font-bold text-white tracking-tight mb-8 leading-[1.1] px-4">
							Where Tradition Meets <br className="hidden md:block" /> Modern Excellence
						</h1>
			...
			<section className="py-24 bg-white border-y border-slate-100">
				<div className="max-w-7xl mx-auto px-4 sm:px-6">
					<div className="text-center mb-16">
						...
						<p className="text-slate-500 font-medium text-lg">World-class infrastructure for the modern student.</p>
					</div>
					<div className="grid grid-cols-2 md:grid-cols-4 gap-8">
						{[
							{ icon: Library, title: "Modern Library", desc: "Vast collection of resources" },
							{ icon: Laptop, title: "Digital Labs", desc: "State-of-the-art facilities" },
							{ icon: Globe, title: "Global Reach", desc: "Connecting with scholars worldwide" },
							{ icon: Users, title: "Community", desc: "Lifelong network of peers" },
						].map((item, i) => (
							<div key={i} className="flex flex-col items-center text-center group">
								...
								<h3 className="font-bold text-lg text-[#0a1628] mb-2">{item.title}</h3>
								<p className="text-xs text-slate-500 font-medium leading-relaxed uppercase tracking-wider">{item.desc}</p>
							</div>
						))}
					</div>
				</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6">
					<div className="flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left">
						<div className="flex flex-col items-center md:items-start gap-6 max-w-md">
							...
							<div>
								<h3 className="text-white text-xl font-display font-bold mb-2">Ahlussuffa Dars</h3>
								<p className="text-slate-400 text-sm leading-relaxed">
									An institution dedicated to the preservation of traditional Islamic values and the advancement of contemporary knowledge.
								</p>
							</div>
						</div>
						...
						<div className="grid grid-cols-2 gap-16">
							<div className="space-y-4">
								<h4 className="text-[#c8922a] text-xs font-bold uppercase tracking-widest">Portal</h4>
								<ul className="space-y-3">
									<li><Link to="/apply/new" className="text-slate-400 hover:text-white text-sm font-medium transition-colors">Admission</Link></li>
									<li><Link to="/locate" className="text-slate-400 hover:text-white text-sm font-medium transition-colors">Locate</Link></li>
								</ul>
							</div>
							<div className="space-y-4">
								<h4 className="text-[#c8922a] text-xs font-bold uppercase tracking-widest">Support</h4>
								<ul className="space-y-3">
									<li><a href="#" className="text-slate-400 hover:text-white text-sm font-medium transition-colors">Contact</a></li>
									<li><a href="#" className="text-slate-400 hover:text-white text-sm font-medium transition-colors">Privacy</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div className="mt-20 pt-10 border-t border-white/5 text-center">
						<p className="text-slate-500 text-[10px] uppercase font-bold tracking-[0.3em]">
							&copy; {new Date().getFullYear()} Ahlussuffa Educational Trust. All Rights Reserved.
						</p>
					</div>
				</div>
			</footer>
